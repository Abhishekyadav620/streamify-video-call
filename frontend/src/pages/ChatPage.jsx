  ...
  useEffect(() => {
    const initChat = async () => {
      ...
      try {
        ...
        const streamAvatar = authUser.profilePic?.includes("avatar.iran.liara.run")
          ? getFallbackAvatarUrl(authUser.fullName)
          : authUser.profilePic || getFallbackAvatarUrl(authUser.fullName);
